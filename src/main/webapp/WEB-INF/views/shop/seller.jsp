	...
	<div class="sellerborder">
		...
		<div class="sellerborder_input">
			...
			<div class="sellerborder_input_item">
				...
				<div class="input_item_input"><input type="text" id="sample6_postcode" placeholder="우편번호"></div>
			...
			<div class="sellerborder_input_item">
				...
				<div class="input_item_input"><input type="text" id="sample6_address" placeholder="주소"></div>
				<div class="input_item_option input_item_input"><input type="text" id="sample6_detailAddress" placeholder="상세주소"></div>
			</div>
			<div class="sellerborder_input_item">
				<div class="input_item_num">
			...
			<div class="sellerborder_input_item">
				...
				<div class="input_item_input"><button id="sellerSubmit">등록하기</button></div>
				<div class="input_item_option"></div>
			</div>
		</div>
	</div>
